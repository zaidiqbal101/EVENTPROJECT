...
const Wedding = () => {
  const [events, setEvents] = useState([
    { id: 1, name: "Alice Johnson", phone: "555-234-5678", email: "alice.johnson@example.com", location: "Boston", date: "2025-01-15", eventType: "Wedding" },
    { id: 2, name: "Michael Brown", phone: "555-876-5432", email: "michael.brown@example.com", location: "Chicago", date: "2025-03-18", eventType: "Birthday" },
    { id: 3, name: "Sophia Martinez", phone: "555-987-6543", email: "sophia.martinez@example.com", location: "San Francisco", date: "2025-02-22", eventType: "Anniversary" },
    { id: 4, name: "Liam Daviss", phone: "555-456-7890", email: "liam.davis@example.com", location: "New York", date: "2025-04-10", eventType: "Wedding" },
    { id: 5, name: "Emma Wilson", phone: "555-123-6789", email: "emma.wilson@example.com", location: "Los Angeles", date: "2025-05-05", eventType: "Birthday" },
    { id: 6, name: "Noah Garcia", phone: "555-789-0123", email: "noah.garcia@example.com", location: "Houston", date: "2025-06-15", eventType: "Wedding" },
    { id: 7, name: "Olivia Miller", phone: "555-321-0987", email: "olivia.miller@example.com", location: "Seattle", date: "2025-07-08", eventType: "Anniversary" },
    { id: 8, name: "James Rodriguez", phone: "555-654-3210", email: "james.rodriguez@example.com", location: "Denver", date: "2025-08-20", eventType: "Wedding" },
    { id: 9, name: "Isabella Perez", phone: "555-987-1234", email: "isabella.perez@example.com", location: "Miami", date: "2025-09-12", eventType: "Birthday" },
    { id: 10, name: "Ethan Harris", phone: "555-456-0987", email: "ethan.harris@example.com", location: "San Diego", date: "2025-10-30", eventType: "Anniversary" },
    { id: 11, name: "Mia Thompson", phone: "555-789-6543", email: "mia.thompson@example.com", location: "Phoenix", date: "2025-11-25", eventType: "Wedding" }
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">Wedding Events</h2>

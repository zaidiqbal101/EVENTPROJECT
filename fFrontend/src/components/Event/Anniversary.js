...
const Anniversary = () => {
  const [events, setEvents] = useState([
    { id: 1, name: "John Doe", phone: "123-456-7890", email: "john@example.com", location: "New York", date: "2025-02-14", eventType: "Anniversary" },
    { id: 2, name: "Jane Smith", phone: "987-654-3210", email: "jane@example.com", location: "Los Angeles", date: "2025-03-22", eventType: "Anniversary" },
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">Anniversary </h2>
